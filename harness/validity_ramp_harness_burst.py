#!/usr/bin/env python3
"""
validity_ramp_harness_burst.py -- measure JSON schema validity as a function of
concurrency against any OpenAI-compatible endpoint.

This is the harness that produced the essay's bounded-burst ramp, and it is kept
...
OpenAI-compatible endpoint.
  ...
  python3 validity_ramp_harness_burst.py --model meta-llama/Llama-3.3-70B-Instruct \
...
async def run_level(concurrency, n_requests, model, mode, max_tokens):
